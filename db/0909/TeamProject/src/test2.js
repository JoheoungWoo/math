...
import { toKRW, toNumber } from "./ShoppingCartPage";
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 flex flex-col">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <Link
                to={`/cart/${productId}`}
                className="p-4 border rounded flex-grow flex items-center justify-center gap-2 no-underline"
              >
                <FaShoppingCart />
              </Link>
              <button className="p-4 bg-black text-white rounded flex-grow">
                바로 구매
              </button>
            </div>
          </div>
