          ...
          <div className="lg:w-1/2 flex flex-col">
            ...
            <div className="mt-4 pt-4 border-t text-sm space-y-2">
              ...
              <p>
                ...
                <span>{toKRW(finalPrice * 0.0)}원 (0%)</span>
                {/* 상품을 결제해서 이 적립금을 받는 정보페이지가 없어서 0%로 임의설정 */}
              </p>
              <p>
            ...
            <div className="mt-6 flex gap-3">
              <button className="p-4 border rounded" onClick={handleSaveClick}>
                <FaHeart />
              </button>
              <button
                onClick={handleAddToCart}
                className="p-4 text-black border rounded no-underline"
              >
                <FaShoppingCart />
              </button>
              <button
