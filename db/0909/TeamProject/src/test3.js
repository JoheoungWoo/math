...
const parsePrice = (priceString) => {
  ...
  return Number(String(priceString).replace(/[^\d]/g, ""));
};

/** 숫자를 KRW 형식으로 포맷 (29900 → "29,900") */
...
const ProductDetailPage = () => {
  ...
  // 가격 및 할인 계산 (임시 데이터)
  const originalPrice = parsePrice(product.price) + 3000;
          ...
          <div className="lg:w-1/2 flex flex-col">
            ...
            <div className="mt-4 pt-4 border-t text-sm space-y-2">
              ...
              <p>
                ...
                <span>{formatKRW(finalPrice * 0.01)}원 (1%)</span>
              </p>
              <p>
            ...
            <div className="mt-4 pt-4 border-t flex items-center justify-between">
              ...
              <span className="font-bold text-2xl">
                {formatKRW(finalPrice * quantity)}원
              </span>
            </div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                className="p-4 border rounded flex-grow flex items-center justify-center gap-2"
              >
                <FaShoppingCart /> 장바구니
              </button>
              <button
